...
impl AgentName {
    ...
    /// Generate the commit signature for this agent
    ///
    /// Returns the signature line appended to commit messages to indicate
    /// they were generated by this AI agent via commitment.
    ///
    /// # Examples
    /// ```
    /// # use commitment_rs::types::AgentName;
    /// assert_eq!(
    ///     AgentName::Claude.commit_signature(),
    ///     "🤖 Generated with Claude via commitment"
    /// );
    /// ```
    pub fn commit_signature(&self) -> String {
        format!("🤖 Generated with {} via commitment", self.display_name())
    }
}
